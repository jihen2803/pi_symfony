        ...
        if (Twig\Extension\CoreExtension::testEmpty((isset($context["velos"]) || array_key_exists("velos", $context) ? $context["velos"] : (function () { throw new RuntimeError('Variable "velos" does not exist.', 77, $this->source); })()))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["velo"]) {
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, $context["velo"], "dispo", [], "any", false, false, false, 111)) {
                    ...
                    // line 120
                    yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reservationvelo_new");
                    yield "\">
                                    <input type=\"hidden\" name=\"velo_id\" value=\"";
                    // line 121
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["velo"], "id_velo", [], "any", false, false, false, 121), "html", null, true);
                    yield "\" />
...
";
    ...
    {
        return array (  318 => 137,  314 => 135,  305 => 131,  299 => 127,  290 => 121,  286 => 120,  280 => 117,  273 => 112,  271 => 111,  267 => 109,  263 => 107,  255 => 105,  253 => 104,  245 => 99,  237 => 98,  232 => 96,  228 => 95,  221 => 90,  217 => 89,  214 => 88,  202 => 78,  200 => 77,  191 => 73,  176 => 61,  162 => 50,  148 => 39,  129 => 23,  122 => 19,  118 => 18,  111 => 14,  101 => 6,  88 => 5,  64 => 3,  41 => 1,);
    }
                    ...
                    <div class=\"col-xl-3 col-lg-4 col-md-6\">
                        <div class=\"card h-100 border-0 shadow-sm bike-card\">
                            <div class=\"card-body\">
                                ...
                                <form method=\"post\" action=\"{{ path('app_reservationvelo_new') }}\">
