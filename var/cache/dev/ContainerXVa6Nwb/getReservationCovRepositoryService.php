 ...
 */
class getReservationCovRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationCovRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationCovRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationCovRepository.php';

        return $container->privates['App\\Repository\\ReservationCovRepository'] = new \App\Repository\ReservationCovRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
