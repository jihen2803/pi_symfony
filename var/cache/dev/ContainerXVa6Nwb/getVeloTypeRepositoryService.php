 ...
 */
class getVeloTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VeloTypeRepository' shared autowired service.
     *
     * @return \App\Repository\VeloTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VeloTypeRepository.php';

        return $container->privates['App\\Repository\\VeloTypeRepository'] = new \App\Repository\VeloTypeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
