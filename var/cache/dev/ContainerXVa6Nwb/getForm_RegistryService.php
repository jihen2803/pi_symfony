...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\CovoiturageType' => ['privates', 'App\\Form\\CovoiturageType', 'getCovoiturageTypeService', true],
            'App\\Form\\ReservationCovType' => ['privates', 'App\\Form\\ReservationCovType', 'getReservationCovTypeService', true],
            'App\\Form\\ReservationTaxiType' => ['privates', 'App\\Form\\ReservationTaxiType', 'getReservationTaxiTypeService', true],
            'App\\Form\\ReservationveloType' => ['privates', 'App\\Form\\ReservationveloType', 'getReservationveloTypeService', true],
            'App\\Form\\StationveloFormType' => ['privates', 'App\\Form\\StationveloFormType', 'getStationveloFormTypeService', true],
            'App\\Form\\VehiculeType' => ['privates', 'App\\Form\\VehiculeType', 'getVehiculeTypeService', true],
            'App\\Form\\VeloType' => ['privates', 'App\\Form\\VeloType', 'getVeloType4Service', true],
            'App\\Form\\VeloTypeType' => ['privates', 'App\\Form\\VeloTypeType', 'getVeloTypeTypeService', true],
            ...
            'App\\Form\\CovoiturageType' => '?',
            'App\\Form\\ReservationCovType' => '?',
            'App\\Form\\ReservationTaxiType' => '?',
            'App\\Form\\ReservationveloType' => '?',
            'App\\Form\\StationveloFormType' => '?',
            'App\\Form\\VehiculeType' => '?',
            'App\\Form\\VeloType' => '?',
            'App\\Form\\VeloTypeType' => '?',
