 ...
 */
class getVeloRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VeloRepository' shared autowired service.
     *
     * @return \App\Repository\VeloRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VeloRepository.php';

        return $container->privates['App\\Repository\\VeloRepository'] = new \App\Repository\VeloRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
