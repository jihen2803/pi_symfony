 ...
 */
class getStationveloRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StationveloRepository' shared autowired service.
     *
     * @return \App\Repository\StationveloRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StationveloRepository.php';

        return $container->privates['App\\Repository\\StationveloRepository'] = new \App\Repository\StationveloRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
