 ...
 */
class getReservationveloRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationveloRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationveloRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationveloRepository.php';

        return $container->privates['App\\Repository\\ReservationveloRepository'] = new \App\Repository\ReservationveloRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
