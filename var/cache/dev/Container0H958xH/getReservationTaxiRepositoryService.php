 ...
 */
class getReservationTaxiRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationTaxiRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationTaxiRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationTaxiRepository.php';

        return $container->privates['App\\Repository\\ReservationTaxiRepository'] = new \App\Repository\ReservationTaxiRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
