 ...
 */
class getPaiementveloRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaiementveloRepository' shared autowired service.
     *
     * @return \App\Repository\PaiementveloRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaiementveloRepository.php';

        return $container->privates['App\\Repository\\PaiementveloRepository'] = new \App\Repository\PaiementveloRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
